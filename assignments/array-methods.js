...
let capitalize = runners.map(function(caps) {
  push caps.first_name.toUpperCase();
});

//runners.map(function(capitalize) {
//return firstNamesAllCaps.push(`${capitalize.first_name}`);
//});
